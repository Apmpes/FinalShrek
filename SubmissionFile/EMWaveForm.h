...
namespace CppCLRWinFormsProject {
    ...
    static EMWaveResult^ RunEMWaveSimulation(double A, double f,
        double alpha, double phi_deg, int steps) {
    ...
    {
    public:
        EMWaveForm(void) : hasSimulated(false) { InitializeComponent(); }
    ...
    private:
        ...
        double lastA, lastF, lastAlpha, lastPhi;
...
#pragma region Windows Form Designer generated code
        void InitializeComponent(void)
        {
            ...
            this->lblA->Anchor = static_cast<System::Windows::Forms::AnchorStyles>(
                System::Windows::Forms::AnchorStyles::Top |
                System::Windows::Forms::AnchorStyles::Left);
            ...
            this->lblF->Anchor = static_cast<System::Windows::Forms::AnchorStyles>(
                System::Windows::Forms::AnchorStyles::Top |
                System::Windows::Forms::AnchorStyles::Left);
            ...
            this->lblAlpha->Anchor = static_cast<System::Windows::Forms::AnchorStyles>(
                System::Windows::Forms::AnchorStyles::Top |
                System::Windows::Forms::AnchorStyles::Left);
            ...
            this->lblPhi->Anchor = static_cast<System::Windows::Forms::AnchorStyles>(
                System::Windows::Forms::AnchorStyles::Top |
                System::Windows::Forms::AnchorStyles::Left);
            ...
            this->tbA->TabIndex = 6;
            this->tbA->Text = L"1";
            this->tbA->Anchor = static_cast<System::Windows::Forms::AnchorStyles>(
                System::Windows::Forms::AnchorStyles::Top |
                System::Windows::Forms::AnchorStyles::Left);
            ...
            this->tbF->TabIndex = 7;
            this->tbF->Text = L"10";
            this->tbF->Anchor = static_cast<System::Windows::Forms::AnchorStyles>(
                System::Windows::Forms::AnchorStyles::Top |
                System::Windows::Forms::AnchorStyles::Left);
            ...
            this->tbAlpha->Anchor = static_cast<System::Windows::Forms::AnchorStyles>(
                System::Windows::Forms::AnchorStyles::Top |
                System::Windows::Forms::AnchorStyles::Left);
            ...
            this->tbPhi->Text = L"0";
            this->tbPhi->Anchor = static_cast<System::Windows::Forms::AnchorStyles>(
                System::Windows::Forms::AnchorStyles::Top |
                System::Windows::Forms::AnchorStyles::Left);
            ...
            this->Resize += gcnew System::EventHandler(this, &EMWaveForm::EMWaveForm_Resize);
...
#pragma endregion
        ...
        void DrawGraph() {
            ...
            EMWaveResult^ result = RunEMWaveSimulation(lastA, lastF, lastAlpha, lastPhi, w - 50);
        ...
        System::Void btnSimulate_Click(System::Object^ sender, System::EventArgs^ e) {
            if (!Double::TryParse(tbA->Text, lastA) || lastA <= 0 ||
                !Double::TryParse(tbF->Text, lastF) || lastF <= 0 ||
                !Double::TryParse(tbAlpha->Text, lastAlpha) || lastAlpha < 0 ||
                !Double::TryParse(tbPhi->Text, lastPhi)) {
        ...
        System::Void EMWaveForm_Resize(System::Object^ sender, System::EventArgs^ e) {
